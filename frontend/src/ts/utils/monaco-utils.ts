...
function defineCustomThemes(): void {
  ...
  monaco.editor.defineTheme("custom-dark", {
    ...
    inherit: true,
    rules: [
      { token: "string.key.json", foreground: "06B6D4" },
      { token: "string.value.json", foreground: "F59E0B" },
      { token: "number", foreground: "FF79C6" },
      { token: "keyword.json", foreground: "B392F0" },
    ...
    colors: {
      ...
      "scrollbarSlider.background": "#0EA5E933",
      "scrollbarSlider.hoverBackground": "#0EA5E955",
      "scrollbarSlider.activeBackground": "#0EA5E977",
    },
  });
