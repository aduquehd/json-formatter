...
import { Github, HelpCircle, Heart, User, ExternalLink } from 'lucide-react';
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-14 py-3 md:py-2 h-full flex items-center justify-between gap-2 md:gap-4">
        <div className="flex flex-col items-start gap-0.5 flex-1">
          <h1 className="text-base sm:text-lg md:text-xl font-bold text-gray-800 dark:text-gray-200 tracking-tight m-0 leading-tight">
            JSON <span className="glitch-text text-blue-600 dark:text-cyan-400" data-text="Formatter">Formatter</span> & <span className="glitch-text text-purple-600 dark:text-purple-400" data-text="Viewer">Viewer</span><span className="hidden lg:inline"> - Online JSON Tools</span>
          </h1>
        ...
        <div className="flex flex-col sm:flex-row items-end sm:items-center gap-1 sm:gap-2 min-w-fit">
          ...
          <div className="flex flex-row items-center gap-1.5 sm:gap-2">
            ...
            >
              ...
              <span className="relative font-semibold bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent group-hover:from-blue-700 group-hover:to-purple-700 dark:group-hover:from-blue-300 dark:group-hover:to-purple-300">Help</span>
            ...
            {/* GitHub button - icon only on mobile */}
            <Link
          ...
          {/* Created by link - separate row on mobile, same row on desktop */}
          <Link
